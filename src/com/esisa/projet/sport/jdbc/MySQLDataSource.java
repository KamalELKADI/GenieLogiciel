package com.esisa.projet.sport.jdbc;
...
public class MySQLDataSource extends DataSource {
	...
	public MySQLDataSource() {
 	...
 	public MySQLDataSource(String host, String source, String user) {
		super(MYSQLDRIVER, MYSQLBRIDGE, host, source, user, "");
 	}
 	
 	public MySQLDataSource(String host, String source) {
		super(MYSQLDRIVER, MYSQLBRIDGE, host, source, "root", "");
 	}
 	
 	public MySQLDataSource(String source) {
		super(MYSQLDRIVER, MYSQLBRIDGE, "localhost", source, "root", "123456");
 	}
