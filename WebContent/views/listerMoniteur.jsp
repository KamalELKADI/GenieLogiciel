<%@page import="com.esisa.projet.sport.models.*"%>
...
<head>
    ...
    <!-- ../admin/BSB Themes. You can choose a theme from css/themes instead of get all themes -->
...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../admin/index.html">../admin/BSB - MATERIAL DESIGN</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>Gestion des Moniteurs</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                                <a href="../admin/pages/tables/normal-tables.html">Ajouter Moniteur</a>
                            </li>
                            <li class="active">
                                <a href="../admin/pages/tables/jquery-datatable.html">Lister Moniteur</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2016 - 2017 <a href="javascript:void(0);">../admin/BSB - Material Design</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
							...
							List<Moniteur> moniteur = (List<Moniteur>)request.getAttribute("model");
							%>
